      ...
      <div className="relative flex items-start justify-center h-auto -mt-2 -mb-2">
        <div className="relative w-full">
          <Image
            ...
            width={900}
            height={500}
            className="mx-auto h-auto max-h-40 w-full object-contain drop-shadow-[0_25px_50px_rgba(15,23,42,0.35)] transition-transform duration-500 group-hover:scale-105"
          />
        </div>
      </div>
